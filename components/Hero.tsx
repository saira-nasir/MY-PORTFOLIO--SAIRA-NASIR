  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update() {
        ...
        const maxDistance = 300; // Increased radius from 200
        ...
        if (distance < maxDistance) {
            ...
            const directionX = forceDirectionX * force * 8; // Increased force from 3
        ...
        <div className="md:col-span-6 flex flex-col justify-center order-2 md:order-1 relative z-40">
          ...
          <div className="animate-fade-in" style={{animationDelay: '0.4s'}}>
             ...
             <div className="flex flex-wrap gap-4 relative z-50">
               <a href="https://www.linkedin.com/in/sairanasir10" target="_blank" rel="noreferrer" className="group cursor-pointer relative bg-cyber-black/50 backdrop-blur-sm border border-white/20 px-6 py-3 overflow-hidden hover:border-neon-blue transition-all duration-200 active:scale-95">
                  <div className="absolute inset-0 bg-neon-blue/10 translate-y-full group-hover:translate-y-0 transition-transform duration-200"></div>
               ...
               <a href="https://github.com/saira-nasir" target="_blank" rel="noreferrer" className="group cursor-pointer relative bg-cyber-black/50 backdrop-blur-sm border border-white/20 px-6 py-3 overflow-hidden hover:border-neon-blue transition-all duration-200 active:scale-95">
                  <div className="absolute inset-0 bg-neon-blue/10 translate-y-full group-hover:translate-y-0 transition-transform duration-200"></div>
                  <div className="flex items-center gap-3 relative z-10">
               ...
               <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sairanasir10014@gmail.com" target="_blank" rel="noopener noreferrer" className="group cursor-pointer relative bg-cyber-black/50 backdrop-blur-sm border border-white/20 px-6 py-3 overflow-hidden hover:border-neon-blue transition-all duration-200 active:scale-95">
                  <div className="absolute inset-0 bg-neon-blue/10 translate-y-full group-hover:translate-y-0 transition-transform duration-200"></div>
                  <div className="flex items-center gap-3 relative z-10">
               ...
               <a href="tel:+923215914252" className="group cursor-pointer relative bg-cyber-black/50 backdrop-blur-sm border border-white/20 px-6 py-3 overflow-hidden hover:border-neon-blue transition-all duration-200 active:scale-95">
                  <div className="absolute inset-0 bg-neon-blue/10 translate-y-full group-hover:translate-y-0 transition-transform duration-200"></div>
                  <div className="flex items-center gap-3 relative z-10">
